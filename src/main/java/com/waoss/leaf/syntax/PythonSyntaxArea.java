...
public class PythonSyntaxArea extends SyntaxArea {

    private static final String[] KEYWORDS = new String[]{
            "abstract", "as", "assert", "break", "class",
            "continue", "def", "del", "elif", "else",
            "except", "exec", "finally", "from",
            "for", "global", "if", "in", "import",
            "is", "lambda", "not", "pass", "print", "raise",
            "return", "self", "try", "while", "with"
    };
